...
document.getElementById('par-calculate').addEventListener('click', function () {

    const firstinput = document.getElementById('par-base');
    const firstValue = firstinput.value;
    const ConvertedFirstValu = parseFloat(firstValue);

    const secondinput = document.getElementById('per-hight');
    ...
    const shapeName = document.getElementById("parallelogram");
    const headofthedisplay = document.getElementById(' ');
